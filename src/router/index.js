  ...
  routes: [
...

    {
      ...
      children: [
        ...
        {
          path: '/teapwd',//修改教师密码
          component: () => import ('@/components/common/teapwd')
        },
        {
          path:'/showmetheclass',//show my class
          component:()=> import('@/components/teacher/showmetheclass')
        }
      ]
    },
    {
    ...
    },
    {
      ...
      children: [
        ...
        {path:'/arcface',component: () => import('@/components/student/arcface')},
        {path:'/myclass',component: () => import('@/components/student/myclass')}
      ]
    },

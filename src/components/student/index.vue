...
<template>
  <div id="student">
    <el-row class="padding-50" style="background-color: #fdf582">
      <el-col :span="24">
        <ul class="list">
          <li class="logo"><span>线上考试</span></li>
          ...
          <li><a href="javascript:;" @click="myclass()">我的班级</a></li>
          
          <!-- <li><router-link to="/message">我的班级</router-link></li> -->
          <li><a href="javascript:;" @click="arcface()">人脸录入</a></li>
          <li @click="message()">学习圈</li>
          <li>正在开发2</li>
...
export default {
  ...
  methods: {
    ...
    message() { //跳转练习模式
      let isPractice = true
      this.$store.commit("message", isPractice)

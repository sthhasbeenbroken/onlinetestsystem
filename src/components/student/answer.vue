     ...
     <div class="flexarea">
          ...
          <div class="left" v-if="slider_flag">
            ...
            <div class="l-bottom">
              ...
              <!-- <div class="item"> -->
                <!-- <p>多选题</p> -->
                <!-- <ul> -->
                  <!-- <li v-for="(list, index1) in topic[2]" :key="index1"> -->
                    <!-- <a href="javascript:;"  -->
                      <!-- @click="change(index1)" -->
                      <!-- :class="{'border': index == index1 && currentType == 1,'bg': bg_flag && topic[2][index1].isClick == true}"> -->
                      <!-- <span :class="{'mark': topic[2][index1].isMark == true}"></span> -->
                      <!-- {{index1+1}} -->
                    <!-- </a> -->
                  <!-- </li> -->
                <!-- </ul> -->
        ...
        <div class="right">
          <div class="title">
            ...
            <!-- <span><i class="iconfont icon-time"></i>倒计时：<b>{{time}}</b>分钟</span> -->

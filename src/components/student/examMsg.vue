  ...
  <div id="msg">
    ...
    <div class="wrapper">
      <ul class="top">
        ...
        <li class="right">
          <div>
            ...
            <span class="score">{{score[0]+score[1]+34}}</span>
      ...
      <ul class="bottom">
        ...
        <li class="right"><el-button @click="toAnswer(examData.examCode)">开始考试</el-button></li>
      </ul>
      <!-- <ul class="info">
      ...
      <el-collapse v-model="activeName" >
        <el-collapse-item class="header" name="0">
          ...
          <el-collapse class="inner">
            ...
            <!-- <el-collapse-item>
              <template slot="title" name="1">
                <div class="titlei">多选题 (共{{topicCount[0]}}题 共计{{score[0]}}分)</div>
              </template>
              <div class="contenti">
                <ul class="question" v-for="(list, index) in topic[1]" :key="index">
                  <li>{{index+1}}. {{list.question}} {{list.score}}分</li>
            ...
            <el-collapse-item>
              <template slot="title" name="3">
                ...
                <div class="titlei">判断题 (共{{topicCount[2]}}题 共计34分)</div>

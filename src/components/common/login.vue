    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top" style="margin-bottom: 15px">
          <span class="title">学无止境考试系统</span>
        </div>
        <div class="bottom">
          <div class="container">
            <p class="title">登录</p>
            <el-form :label-position="labelPosition" label-width="60px" :model="formLabelAlign">
              ...
              <div class="submit">
                <el-button type="primary" class="row-login" @click="login()" style="margin-left:20px">登录</el-button>
              </div>
              <div class="options">
                <!-- <p class="find"><a href="javascript:;">找回密码</a></p> -->
                <div class="register">
                  <!-- <span>没有账号?</span> -->
                  <span><a href="javascript:;" style=" margin-left:280px">注册</a></span>
                </div>
              </div>
            </el-form>
          </div>

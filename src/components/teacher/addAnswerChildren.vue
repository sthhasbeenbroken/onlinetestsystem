    ...
    <el-tab-pane name="first">
      ...
      <section class="append">
        <ul>
          ...
          <el-button @click="searchlib()">查看题库</el-button>
          <el-dialog :visible.sync="openquestionbank" append-to-body style="width:110%;">
          <questionbank v-if="openquestionbank" ref="questionbank"></questionbank>
          </el-dialog>
        </ul>
        <!-- 选择题部分 -->
